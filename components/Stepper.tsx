  ...
  return (
    <div className='flex rounded-lg h-1/2 lg:h-3/5 w-2/3 lg:w-2/5 border shadow-lg overflow-hidden' >
        ...
        <div className='flex flex-col relative w-full md:w-2/3 h-full'>
            ...
            {/* <div className='flex border-t bg-red-500 bottom-0 w-full items-end py-2 ' >
